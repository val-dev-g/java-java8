...
public class Lambda_01_Test {
    ...
    public void test_filter_by_age() throws Exception {
        ...
        PersonPredicate predicate18ans = p -> p.getAge() >= 18;
        List<Person> result = filter(personList, predicate18ans);
    ...
    public void test_filter_by_firstname() throws Exception {
        ...
        PersonPredicate predicatePrenom = p -> p.getFirstname().equals("first_10");
        List<Person> result = filter(personList, predicatePrenom);
